# „Álmomból felébresztve” – zenei playlist a PDF alapján; meglévő audio útvonalak (audio_files/ alatti relatív).
# Hiányzó a könyvtárból (nincs bekötve): Basket Case (Green Day), Sweet Home Alabama, Iris (Goo Goo Dolls),
# 20th Century Boy (T.Rex), More Than a Feeling (Boston), Walking on the Sun (Smash Mouth).
